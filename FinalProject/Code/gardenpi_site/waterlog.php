...
<!--
 ...
 PURPOSE:           This page will display a watering log to see all of the times the plant has been watered
-->
...
<head>
	...
	<title>GardenPi - Watering Log</title>
...
<body>
<!-- php script to pull watering log data from database -->
<?php
	...
	try {
        ...
        $stmt = $conn->query("SELECT * FROM watering_log");
	...
	<ul id="nav-bar">
		...
		<li><a class="active" href="waterlog.php">Watering Log</a></li>
	</ul>
	<!-- end nav bar -->
