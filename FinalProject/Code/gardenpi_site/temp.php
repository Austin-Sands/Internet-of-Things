...
<!--
 ...
 PURPOSE:           This page will display all data for temperature
-->
...
<head>
	...
	<title>GardenPi - Temperature Data</title>
...
<body>
<!-- php script to pull temp data from database -->
<?php
	...
	try {
        ...
        $stmt = $conn->query("SELECT * FROM temp_data");
	...
	<ul id="nav-bar">
		...
		<li><a class="active" href="temp.php">Temp Data</a></li>
