...
<!--
 ...
 PURPOSE:           This page will display all data for moisture readings
-->
...
<head>
	...
	<title>GardenPi - Moisture Data</title>
...
<body>
<!-- php script to pull moisture data from database -->
<?php
	...
	try {
        ...
        $stmt = $conn->query("SELECT * FROM moisture_data");
	...
	<ul id="nav-bar">
		...
		<li><a class="active" href="moisture.php">Moisture Data</a></li>
                ...
                <tbody>
                    <?php
                        ...
                        for ($i = $first_record; $i <= $final_record; $i++) {
                            $record = $result[$i];
                            if($record['reading'] == 0) { $moisture_reading = "Dry"; }
